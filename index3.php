...
map.setCenter(new GLatLng(js_fromuser_lat_scrolled_init, js_fromuser_lon), 13);		new GKeyboardHandler(map);
		...
		tempstring2="<a href=\"/index3.php?lat=" + result_lat + "&lon=" + result_lon +"\">| Вземи линк | <\/a>";
...
//		icon.shadowSize = new GSize(22, 20);
		...
		GEvent.addListener(map,"click", function(overlay,point) 
		{
			if(overlay)
			{
				...
				tempstring1="<a href=\"/index3.php?lat=" + result_lat + "&lon=" + result_lon +"\">| Вземи линк | <\/a> <a href=\"upload_get_file.php?lat=" + result_lat + "&lon=" + result_lon +"\"> Качи панорама | <\/a>";
		...
		GDownloadUrl(js_fromuser_mymap, function(data, responseCode) 
		{
			...
			{	
				map.openInfoWindowHtml(point, 
				  "<iframe src=\"" + xlink + "\"height=\"285\" width=\"579\" frameborder=\"0\" scrolling=\"no\"> Your browser does not understand IFrames. Try another browser<\/iframe>");
			}
			else {
				if (infoopened == 0)
				{
					infoopened = 1;
					map.openInfoWindowHtml(pointFU, "<a href=\"/index3.php?lat=" + result_lat + "&lon=" + result_lon +"\" style=\"color: rgb(33,33,256); text-decoration : underline\">Вземи линк от тази точка<\/a>  <br> 											   <a href=\"upload2d_get_file.php?lat=" + result_lat + "&lon=" + result_lon +"\" style=\"color: rgb(33,33,256); text-decoration : underline\"> Качи снимка тук<\/a> <br>											   <a href=\"upload_get_file.php?lat=" + result_lat + "&lon=" + result_lon +"\" style=\"color: rgb(33,33,256); text-decoration : underline\"> Качи панорама тук<\/a> <br> <a href=\" upload_tag_get_data.php?lat=" + result_lat + "&lon=" + result_lon +"\" style=\"color: rgb(33,33,256); text-decoration : underline\"> Качи описание тук<\/a>");
				}
				}
...
<img src="headlogoslant-300.png" alt="logo">
</div>
